...
export default function StockPage() {
  ...
  function downloadTemplate() {
    ...
    const headers = [
      ["ข้อมูลทั่วไป","","","","ข้อมูลการซื้อ","ข้อมูลการขาย","ยอดยกมา","TikTok","","Shopee","","Lazada",""],
      ["รหัสสินค้า","ชื่อสินค้า*","หมวดหมู่","หน่วยสินค้า (ตัวอย่าง: ชิ้น, ตัว)","ราคาต่อหน่วย","ราคาขาย","จำนวนหน่วย","ชื่อบน TikTok","Variant TikTok","ชื่อบน Shopee","Variant Shopee","ชื่อบน Lazada","Variant Lazada"],
      ["P0001","เสื้อยืด","เสื้อผ้า","ตัว","150","350","10","เสื้อยืด คอกลม","สีขาว ไซส์ M","เสื้อยืด","สีขาว M","",""],
      ["P0002","เสื้อยืด","เสื้อผ้า","ตัว","150","350","8","เสื้อยืด คอกลม","สีดำ ไซส์ L","เสื้อยืด","สีดำ L","",""],
    ];
    const ws = XLSX.utils.aoa_to_sheet(headers);
    ws["!cols"] = [{wch:12},{wch:20},{wch:12},{wch:18},{wch:12},{wch:10},{wch:10},{wch:22},{wch:18},{wch:22},{wch:18},{wch:22},{wch:18}];
