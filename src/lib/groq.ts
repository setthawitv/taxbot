...
const PROMPT_LINES = [
  ...
  '- date: ALWAYS return Gregorian (AD) "YYYY-MM-DD". Use these rules:',
  '  * Thai bank slips use "DD MMM YY" → FIRST number = DAY, MIDDLE = month name, LAST number = year.',
  '  * NEVER treat the first number as the year. "20 May 26" = day 20, month May, year 26 → "2026-05-20".',
  '  * More examples: "24 May 26"→"2026-05-24", "3 Jun 26"→"2026-06-03", "15 Jan 25"→"2025-01-15".',
  '  * 2-digit year 20–30 → prepend "20" → AD year. "26"→2026, "25"→2025, "20"→2020.',
  '  * 2-digit year 60–69 → Thai BE last 2 digits → full BE=25YY → AD=25YY−543. "67"→BE2567→AD2024.',
